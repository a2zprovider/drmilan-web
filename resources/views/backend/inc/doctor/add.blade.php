...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {{ Form::open(['url' => route('admin.doctor.store'), 'method'=>'POST', 'files' => true, 'class' => 'needs-validation','novalidate']) }}
        <div class="card mb-4 header-sticky">
            <div class="d-flex justify-content-between align-items-center py-3 mb-2 card-body">
                <h4 class="fw-bold m-0">
                    <span class="text-muted fw-light">Doctor /</span> Add
                </h4>

                <div>
                    <a class="btn-primary btn" id="confirm-reset" style="margin-right: 20px; color: #fff">Cancel</a>
                    <button class="btn-primary btn" type="submit">Submit</button>
                </div>
            </div>
        </div>

        @include('backend.inc.doctor._form')
...
<script>
    $('form').submit(function() {
        $(this).find(".form-control:invalid")[0].focus();
    ...
    $(document).ready(function() {
        ...
        $(add_button).click(function(e) {
            ...
            if (x < max_fields) {
                x++;
                $(wrapper).append(`<div class="row mt-3"><div class="col-md-5"> <label class="form-label">From</label><input type="text" name="field[from][]" required class="form-control"  placeholder="From"><div class="invalid-feedback"> Please enter field from. </div></div><div class="col-md-5"> <label class="form-label">To</label><input type="text" name="field[to][]" class="form-control"  placeholder="To" required><div class="invalid-feedback"> Please enter field to. </div></div><div class="col-md-2 mt-1"><a href="#" class="delete btn btn-label-danger mt-4"><i class="bx bx-x"></i><span class="align-middle">Delete</span></a></div></div>`); //add input box
